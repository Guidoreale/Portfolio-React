...
export default function AboutMe() {
        return <>
            <div>
                <h3 className='text-3xl py-1 pt-10 dark:text-teal-600'>Sobre Mi</h3>
            ...
            <div className=' lg:flex lg:justify-center gap-10'>
                <div className='text-center  shadow-2xl p-10 rounded-xl my-10 dark:text-gray-400 dark:shadow-gray-700'>
